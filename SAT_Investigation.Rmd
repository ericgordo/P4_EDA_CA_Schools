...
**To read or access files from this full investigation, click [here](https://github.com/ericgordo/P4_EDA_CA_Schools)**

This analysis compares schools accross the state of Calfiornia. Specifically, at each school I investigate the number of students who score above average on the SAT and ACT academic tests. The average score of the SAT is a 1500, and the average score on the ACT test is 21. 

### The Data Investigated
The data in this analysis is the collection of publically accessible files from the California Department of Education (CDE). This data combines the average test scores from 1,252 California public schools. All of this data is recorded from the 2014-2015 school year. 

There are many interesting insights to be noted about this data, and for a full report follow one of the links mentioned above.

## Percent of Students who Score Above Average on Each Test

Each point on the chart below represents a seperate school. The X axis postion of the point represents the perecent of students at the school who scored above average on the ACT, while the Y axis position represents the percent of students scoring above average on the SAT. Thus the schools in the top right corner have more students who score above average on both tests, while the bottom left corner represents schools in which the smallest percent of students perform above average on each test. The orange points represent traditional public schools, and the blue dots represent charter schools.
...
The graph above shows that schools vary in what percent of students perform above average on both tests. However there seems to be a disparity between the charter schools and traditional pulic schools. Let's investigate some stats.
...
There are 125 charter schools on the graph above, and 945 traditional public schools. The stats above also show that on average, 40% of students score above average on the SAT at a traditional public school, while only 33% of students at Charter schools score above average. Similarly for the ACT, 53% of students perform above average at every public school, compared to 39.6% at charter schools. 

## Statistic Tests for Significance

To determine the significance of this difference, we can run a statistcal test to see if the mean number of students who score above average on the SAT and ACT is statistically difference. That is we will test the following questions with the given hypothesis. 

Do public schools have a higher percentage of students who score above average than charter schools? 
...
The results above show that there is statistical significance difference in the percent of students who score above average in both tests at public schools compared to charter schools. This can be seen in the small p-values from both tests above. The Wilcoxon-Mann-Whitney test was used because none of the distributions were normal. 
...
Below are some maps of the locations of schools throughout the state of California, as well as a color corosponding to some statistic of each school. 
...
# Further Work
This Report was just a small sample of the data investigated. For the full report, with deeper data examination as well as a more robust conclusions, please follow the link at the top of the page. 
